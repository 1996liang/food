							...
							<div class="am-tab-panel am-fade am-in am-active" id="tab1">
								...
								<div class="order-main">
									<div class="order-list">
										...
										<!--交易成功-->
										<s:iterator value="#request.allOrders" var="order">
											<div class="order-status5">
												...
												<div class="order-title">
													...
													<span>成交时间：<!-- 2015-12-20 -->${order.orderTime}</span>
													<!--    <em>店铺：小桔灯</em>-->
												</div>
													...
													<div class="order-right">
															...
															<div class="move-right">
																<li class="td td-status">
																	<div class="item-status">
																		...
																		<p class="order-info">
																			<a href="orderInfo_getOrderInfo?order.id=${order.id}">订单详情</a>
																		</p>
																	</div>
																</li>
														...
														<s:elseif test="#order.status==3">
															...
															<div class="move-right">
																...
																<li class="td td-change"><a href="evaluate_redirectPage?order.id=${order.id}">
													...
													<!-- 卖家未付款 -->
														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	<p class="Mystatus">买家已付款</p>
																	<p class="order-info"><a href="orderInfo_getOrderInfo?order.id=${order.id}">订单详情</a></p>
																</div>
															</li>
															<li class="td td-change">
												...
												<div class="order-right">
													<!-- 买家已发货 -->
														...
														<div class="move-right">
															...
															<li class="td td-change">
																<a href="evaluate_redirectPage?order.id=${order.id}">
																	<div class="am-btn am-btn-danger anniu">
																		评价商品</div>
																</a>
															</li>
