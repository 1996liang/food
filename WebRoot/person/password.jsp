		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<form class="am-form am-form-horizontal" method="POST"
					action="safeSetUp_alterPassword" onsubmit="submit()">
					...
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-new-password"
								placeholder="由数字、字母组合" name="user.password">
						</div>
					</div>
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-confirm-password"
								placeholder="请再次输入上面的密码" name="rePassword">
						</div>
					</div>
					<input type="hidden" value="${application.user.id}" name="user.id">
					<div class="info-btn">
