...
<script type="text/javascript" src="../js/introduction2.js"></script>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						...
						<a href="${session.goods.getImagesArray()[0]}"><img
							src="${session.goods.getImagesArray()[0]}"
							alt="细节展示放大镜特效"
							rel="${session.goods.getImagesArray()[0]}"
							class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img
									src="${session.goods.getImagesArray()[0]}"
									mid="${session.goods.getImagesArray()[0]}"
									big="${session.goods.getImagesArray()[0]}"></a>
							</div>
						</li>
						<s:iterator value="#session.goods.getImagesArray()" var="image"
							status="st">
							<s:if test="#st.index!=0">
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${image}"
											mid="${image}" big="${image}"></a>
									</div>
								</li>
							</s:if>
						</s:iterator>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${session.goods.latelyPrice}</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${session.goods.originalPrice}</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
					...
					<ul class="tm-ind-panel">
						...
						<li class="tm-ind-item tm-ind-sumCount canClick">
							<div class="tm-indcon">
								<span class="tm-label">累计销量</span><span class="tm-count">
									${session.goods.salesVolume}</span>
							</div>
						</li>
						<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
							<div class="tm-indcon">
								<span class="tm-label">累计评价</span><span class="tm-count">${session.evaluateCount}</span>
							</div>
						</li>
					</ul>
					<div class="clear"></div>
								...
								<div class="theme-popbod dform">
									<form class="theme-signin" name="loginform" action=""
										...
										<div class="theme-signin-left">
											<s:iterator value="#session.goodsOptionsList" var="list">
												<div class="theme-options">
													<s:iterator value="#list.keySet()" var="key">
														<div class="cart-title">${key.name}</div>
														<ul>
															<s:iterator value="#list.get(#key)" var="value"
																status="st">
																<s:if test="#st.index==0">
																	<li class="sku-line selected" id="tb-selected">${value.name}<i>${value.id}</i></li>
																</s:if>
																<s:else>
																	<li class="sku-line">${value.name}<i>${value.id}</i></li>
																</s:else>
															</s:iterator>
														</ul>
													</s:iterator>
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														...
														class="tb-hidden">库存<span class="stock">${session.goods.surplus}</span>件
													</span>
												</dd>
					...
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="LikBasket" title="加入购物车"
								href="car_addCart?user.id=${application.user.id}&goods.id=${session.goods.id}"
								onclick="addCart(event)"><i></i>加入购物车</a>
						</div>
					</li>
				</div>
					...
					<div class="am-tabs-bd">
						...
						<div class="am-tab-panel am-fade am-in am-active">
							...
							<div class="details">
								...
								<div class="twlistNews">
									<s:iterator value="#session.goods.getDescribeImageArray()"
										var="image">
										<img src="${image}" />
									</s:iterator>
						...
						<div class="am-tab-panel am-fade">
								...
								<ul class=" tb-taglist am-avg-sm-4">
									<li class="tb-taglist-li tb-taglist-li-current">
										<div class="comment-info">
											<span>全部评价</span> <span class="tb-tbcr-num count">(${session.evaluateCount})</span>
										</div>
									</li>

									<li class="tb-taglist-li tb-taglist-li-1">
										<div class="comment-info">
											<span>好评</span> <span class="tb-tbcr-num goodCount">(${session.star1})</span>
										</div>
									</li>

									<li class="tb-taglist-li tb-taglist-li-0">
										<div class="comment-info">
											<span>中评</span> <span class="tb-tbcr-num">(${session.star2})</span>
										</div>
									</li>

									<li class="tb-taglist-li tb-taglist-li--1">
										<div class="comment-info">
											<span>差评</span> <span class="tb-tbcr-num">(${session.star3})</span>
										</div>
									</li>
								</ul>
							</div>
							...
							<ul class="am-comments-list am-comments-list-flip">
								<s:iterator value="#session.goodsEvaluateList" var="item">
									<li class="am-comment">
												...
												<div class="tb-rev-item " data-id="255776406962">
													...
													<div class="tb-r-act-bar">
														<s:iterator value="#item.orderItem.goodsOptions"
															var="option">
																${option.goodsOptions.name }：${option.name }&nbsp;&nbsp;
																</s:iterator>
													</div>
												</div>
						...
						<div class="am-tab-panel am-fade">
							<div class="like">
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									<s:iterator value="#session.likeGoodsSet" var="likeGoods">
										<li><a
											href="introduction_goodsIntroduction?goods.id=${likeGoods.id}"
											target="_blank">
												<div class="i-pic limit">
													<img src="${likeGoods.getImagesArray()[0] }" />
													<p>${likeGoods.goodsName}</span>
													</p>
													<p class="price fl">
														<b>¥</b> <strong>${likeGoods.latelyPrice}</strong>
													</p>
												</div>
										</a></li>
									</s:iterator>
